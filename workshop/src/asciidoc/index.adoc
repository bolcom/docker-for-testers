...
**The purpose of this workshop is to learn how to use Docker on your local machine.** Afterwards, it is up to you to explore the rest of the Docker ecosystem!
